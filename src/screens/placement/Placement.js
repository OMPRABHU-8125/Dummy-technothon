...
const Placement = () => {
    ...
    handleRecruitersPress = (url) => {
        Linking.openURL(url);
      };
      
      handleInternshipDetailsPress = (url) => {
        Linking.openURL(url);
      };
      
      handlePlacementDetailsPress = (year) => {
        let pdfUrl = '';
        switch (year) {
          case '2021-22':
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.content}>
                <Image
                  source={require('../../assets/imgs/Kalpesh-B.jpg')}
                    style={styles.image}
                />
                ...
                <View style={styles.section}>
                        ...
                        <Text style={styles.aboutText}>We are proud of achieving remarkable placements and we would like to thank the corporate world for showing immense faith in our students and helping us to continue our legacy of excellence.
</Text>
                    </View>
                ...
                <View style={styles.section}>
                        <TouchableOpacity onPress={() => this.handleRecruitersPress('https://ves.ac.in/polytechnic/wp-content/uploads/2023/03/Our-Recruiters-logos-1.pdf')}>
                            <Text style={styles.subHeading}>Our Recruiters</Text>
                        </TouchableOpacity>
                </View>
                 <View style={styles.section}>
                        <TouchableOpacity onPress={() => this.handleInternshipDetailsPress('https://ves.ac.in/polytechnic/wp-content/uploads/2023/03/Internship-Details.pdf')}>
